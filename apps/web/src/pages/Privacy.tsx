...
export default function Privacy() {
  ...
  return (
    ...
    >
      <Link to="/" className="text-rihla-muted text-sm hover:text-rihla-text">← Back</Link>

      <h1 className="font-display text-4xl text-rihla-text mt-6 mb-2">Privacy Policy</h1>
      <p className="text-rihla-muted text-sm mb-10">PDPL-aligned · Last updated 2026-05-20</p>

      <section className="space-y-8 text-rihla-text/90 leading-relaxed">
        <div>
          <h2 className="font-display text-xl text-rihla-text mb-3">What we collect</h2>
          <p className="text-sm">
        ...
        <div>
          <h2 className="font-display text-xl text-rihla-text mb-3">How we use it</h2>
          <p className="text-sm">
        ...
        <div>
          <h2 className="font-display text-xl text-rihla-text mb-3">Your rights</h2>
          ...
          <div className="glass rounded-2xl p-5 space-y-3">
            <p className="text-rihla-muted text-xs">
              Session: <span className="text-rihla-text font-mono">{sessionId ?? '—'}</span>
            </p>
            ...
            {!sessionId && <p className="text-rihla-muted text-xs">Start a session on the home page first.</p>}
          </div>
        </div>

        <div>
          <h2 className="font-display text-xl text-rihla-text mb-3">Third parties</h2>
